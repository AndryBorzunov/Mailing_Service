...
from mailing.views import (
    ...
    DispatchUpdateView,
    DispatchDeleteView,
    RecipientMailListView,
    RecipientMailDetailView,
    RecipientMailCreateView,
    RecipientMailUpdateView,
    RecipientMailDeleteView,
    MailingSummaryView,
    MessageListView,
    MessageDetailView,
    MessageCreateView,
...
urlpatterns = [
    ...
    path(
        "recipient_mails/create/",
        RecipientMailCreateView.as_view(),
        name="recipientmail_create",
    ),
    path(
        "recipientmail/<int:pk>/update/",
        RecipientMailUpdateView.as_view(),
        name="recipientmail_update",
    ),
    path(
        "recipientmail/<int:pk>/delete/",
        RecipientMailDeleteView.as_view(),
        name="recipientmail_delete",
    ),
